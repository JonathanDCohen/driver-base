...
from driver_base.consistency import ParseConsistencyFailure, enforce_consistency
...
def test_no_ts_warn_for_hf_compression() -> None:
    d = _driver(driver_kind=DriverKind.HF_COMPRESSION, fs_hz=None, qts=None, qes=None, qms=None)
    kept, _ = enforce_consistency([d])
